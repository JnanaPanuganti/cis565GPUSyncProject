...
// *********************************************************************
const char* cSourceFile = "Mutex.cl";
...
int main(int argc, char **argv)
{
	...
	shrSetLogFileName ("Mutex_Spin.txt");
	...
	ciErr1 = clSetKernelArg(ckKernel, 0, sizeof(cl_mem), (void*)&lock);
	ciErr1 |= clSetKernelArg(ckKernel, 1, sizeof(cl_mem), (void*)&sum);
